...
function Blog({ items }) {
  ...
  return (
    <div className="overflow-hidden">
      <div className="bg-[#FF474C]">
        {/* Blog Posts */}

        <div className="text md:p-auto mx-auto max-w-5xl p-7 text-left text-[#FF474C] md:text-center">
          ...
          <Link href="/reviews">
            ...
            <button className='relative text-lg font-semibold px-12 py-4 bg-[#FF474C] rounded-lg mr-5 text-[#FF474C] hover:bg-[#FF474C] cursor-pointer '>Check Reviews</button>
          ...
          <hr className='border-red-600 pb-7  ' />
